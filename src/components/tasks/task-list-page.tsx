...
const variantShells = {
  ...
  'article-journal':
    'bg-[radial-gradient(circle_at_100%_0%,rgba(250,204,21,0.12),transparent_38%),linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)]',
  ...
  const ui = isDark
    ...
    : layoutKey.startsWith('article') || layoutKey.startsWith('sbm')
      ? {
          ...
          panel: 'border border-slate-200 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.05)]',
          soft: 'border border-slate-200 bg-slate-50',
          input: 'rounded-full border border-slate-200 bg-white text-slate-900',
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        {layoutKey === 'listing-directory' || layoutKey === 'listing-showcase' ? (
          <section className="mb-12 grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div className={`rounded-lg p-7 shadow-[0_24px_70px_rgba(15,23,42,0.07)] ${ui.panel}`}>
            ...
            <form className={`grid gap-3 rounded-lg p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)] ${ui.soft}`} action={taskConfig?.route || '#'}>
              <div>
        ...
        {layoutKey === 'article-editorial' || layoutKey === 'article-journal' ? (
          <section className="mb-12 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            ...
            <div className={`rounded-lg p-6 ${ui.panel}`}>
        ...
        {layoutKey === 'image-masonry' || layoutKey === 'image-portfolio' ? (
          <section className="mb-12 grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className={`min-h-[220px] rounded-lg ${ui.panel}`} />
              <div className={`min-h-[220px] rounded-lg ${ui.soft}`} />
              <div className={`col-span-2 min-h-[120px] rounded-lg ${ui.panel}`} />
            </div>
          </section>
        ) : null}

        {layoutKey === 'profile-creator' || layoutKey === 'profile-business' ? (
          <section className={`mb-12 rounded-lg p-8 shadow-[0_24px_70px_rgba(15,23,42,0.1)] ${ui.panel}`}>
            <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
              <div className={`min-h-[240px] rounded-lg ${ui.soft}`} />
              <div>
                <p className={`text-xs uppercase tracking-[0.3em] ${ui.muted}`}>{taskConfig?.label || task}</p>
        ...
        {intro ? (
          <section className={`mb-12 rounded-lg p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)] sm:p-8 ${ui.panel}`}>
